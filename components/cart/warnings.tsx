...
function CartWarningMessages({ group }: { group: CartErrorGroup }) {
  ...
  return (
    <div
      ...
      className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm text-amber-900"
    >
      <div className="flex items-start gap-2.5">
        ...
        <div className="grid flex-1 gap-1">
          ...
          <ul className="grid gap-0.5 text-amber-800">
        ...
        <button
          ...
          aria-label="Dismiss"
          className="inline-flex size-6 shrink-0 cursor-pointer items-center justify-center rounded-md hover:bg-amber-100"
        >
