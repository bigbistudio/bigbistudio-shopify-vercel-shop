  ...
  return (
    ...
    >
      <Container className="flex justify-center py-2">
        <div className="flex max-h-16 items-center justify-between gap-0.5 lg:gap-4 px-3 py-2 bg-background/80 lg:bg-background/45 hover:bg-background/90 duration-600 transition-colors backdrop-blur-lg lg:backdrop-blur-sm border border-border/40 rounded-lg w-full lg:w-fit lg:min-w-3xl lg:max-w-full overflow-hidden">
